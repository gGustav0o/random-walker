...
class WithoutReferenceToolBarViewModel : public QObject {
	Q_OBJECT
...
public:
	explicit WithoutReferenceToolBarViewModel(QObject* parent = nullptr) : QObject(parent), visible_(false) { }
    enum Step{
        Preprocess
        , ROI
        , Segment
